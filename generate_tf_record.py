...
def main():
    ...
    create_tf_record(config.DatasetConfig.image_dir, df_label_train, config.DatasetConfig.charset, output_path, des='Train')

    output_path = os.path.join(config.DatasetConfig.data_dir, f'{config.DatasetConfig.data_name}_test.records')
    create_tf_record(config.DatasetConfig.image_dir, df_label_test, config.DatasetConfig.charset, output_path, des='Test')
