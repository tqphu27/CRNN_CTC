...
class DatasetConfig:
    data_name = 'VietcomBank'
    image_dir = './datasets/VietcomBank/img'
    label_file = './datasets/VietcomBank/vcb_captcha_0_800.csv'
    work_dir = './datasets/VietcomBank'
